...
A fun intro to the R programming language on salmon populations for absolute beginers. We will be analyzing data from the [Gisasa Weir Dam in Alaska](https://catalog.data.gov/dataset/age-sex-and-length-of-chum-salmon-and-chinook-salmon-sampled-at-the-gisasa-weir-between-19-291e2)
<p align="center">
